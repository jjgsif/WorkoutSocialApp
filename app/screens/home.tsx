...
import { Builder } from '../tabs (firebase)/Builder';
    ...
    return(
        <NavigationContainer independent={true}>
            <Tab.Navigator>
                ...
                <Tab.Screen name='Workouts' component={Builder}  options={{ headerShown: false, tabBarIcon: (obj)=>{return obj.focused ? <Ionicons name="pencil" color={"blue"}/> : <Ionicons name="pencil-outline" /> } }}/>
            </Tab.Navigator>
        </NavigationContainer>
    )
}
